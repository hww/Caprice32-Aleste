...
defb "This test flashes the RUS led on the aleste and the border.",13,10
defb "The border should be white when the led is on and black when",13,10
defb "it is off.",13,10,13,10
defb "RUS is bit 4 of port 7fxx when bit 7=1 and bit 6=0",13,10,13,10
