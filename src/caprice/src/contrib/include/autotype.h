...
EXTERN_C void CapAutoType_Init();
EXTERN_C void CapAutoType_Term();

EXTERN_C BOOL CapAutoType_Active();

/* set the string to auto type */
EXTERN_C void CapAutoType_SetString(const TCHAR*sString, BOOL bWaitInput);

/* execute this every emulated frame; even if it will be skipped */
EXTERN_C void CapAutoType_Update(void);
