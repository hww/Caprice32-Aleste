...
// Operations
public:
   BOOL Open      (const EMUAPI*, LPCTSTR szPath);
   ...
   BOOL GetVideoMode(int* mode) const;
   BOOL PutVideoMode(int mode);

   BOOL GetTextMode(int* mode) const;
   BOOL PutTextMode(int mode);

   BOOL GetKeyboard(int* keyboard) const;
   BOOL PutKeyboard(int keyboard);

   BOOL GetFullscreen(void) const;
   BOOL PutFullscreen(BOOL bEnable);
